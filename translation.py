...
"""
    ...
    UPGRADE_TEXT = "<b>All features are free for subscribers of @ax_botz enojoy😁 </b>  /help for Details"
...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = " JOIN : https://t.me/ax_botzchat\nFor any queries or suggestions"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nJoin : https://t.me/ax_botz\nUploaded in {} seconds."
...
Bot Powered by: @ax_botz"""
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Join : @ax_botzchat \n For talking with the owner. "
    EXTRACT_ZIP_INTRO_ONE = "Send a compressed file first, Then reply /unzip command to the file."
    EXTRACT_ZIP_INTRO_THREE = "Analyzing received file. ⚠️ This might take some time. Please be patient. "
    UNZIP_SUPPORTED_EXTENSIONS = ("zip", "rar")
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if issue persists head towards @ax_botz</a>"
